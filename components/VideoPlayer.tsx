...
import { X, CloudOff, Cloud, Rewind, FastForward, ChevronRight, ChevronLeft, Copy, FolderPlus, Play, Pause, Volume2, VolumeX, Maximize, Minimize } from 'lucide-react';
    ...
    >
      ...
      >
        ...
        <div className="absolute top-0 left-0 right-0 p-4 flex justify-between items-center">
          <h3 className="text-white font-medium truncate pr-8">{recording.title}</h3>
          <button 
            onClick={onClose}
